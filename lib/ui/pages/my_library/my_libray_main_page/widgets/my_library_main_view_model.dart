...
// 창고
class MyLibraryMainViewModel extends StateNotifier<MyLibraryMainModel?> {
  MyLibraryMainViewModel(super._state, this.ref);
  ...
  Future<void> notifyInit(int userId) async {
    ...
    ResponseDTO responseDTO =
        await MyLibraryRepository().fetchMyLibraryInfo(sessionUser.jwt!);
